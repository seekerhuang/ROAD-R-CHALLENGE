...
from gen_dets2 import gen_dets
...
def main():
    ...
    parser.add_argument('--SEQ_LEN', default=80,
                        type=int, help='NUmber of input frames')
    parser.add_argument('--TEST_SEQ_LEN', default=72,
                        type=int, help='NUmber of input frames')
    ...
    parser.add_argument('--GEN_TOPK', default=20, 
