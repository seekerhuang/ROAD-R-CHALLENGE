...
class DinoRetinaNet(nn.Module):
    ...
    def __init__(self, backbone, args):
        ...
        self.cls_heads = self.make_head_cls(
            self.ar * self.num_classes, args.CLS_HEAD_TIME_SIZE, self.HEAD_LAYERS)
        self.linearcls=dinov2linear(1024)
        self.linearup1=dinov2linearFix(1024,5632)#64 88
        self.linearup2=dinov2linearFix(1024,1408) #32 44
        self.lineardown1=dinov2linearFix(1024,352)#16 22
        self.lineardown2=dinov2linearFix(1024,88)#8 11
        self.lineardown3=dinov2linearFix(1024,24)#4 6
