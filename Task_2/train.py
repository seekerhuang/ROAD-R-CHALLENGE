...
def setup_training(args, net):
    ...
    num_steps = 484 * args.MAX_EPOCHS #Note:!!!if you change the batch size, you need to change the num_steps!!!
    ...
    if args.pretrained_model_path is not None and args.RESUME == 0:
        ...
        print("missing")
        print(result.missing_keys) # print missing keys
        print("unexpcted")
        print(result.unexpected_keys) # print unexpected keys
