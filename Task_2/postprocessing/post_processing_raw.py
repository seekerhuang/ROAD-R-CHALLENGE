...
def main():
    ...
    parser.add_argument('--threshold', type=float, default=0.4, help='Threshold at which a label is considered as predicted. If label > threshold then it is considered predicted.')
