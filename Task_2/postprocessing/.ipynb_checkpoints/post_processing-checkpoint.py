...
def main():
    ...
    requirements_temp_path = "/root/autodl-tmp/road-dataset-master/ROAD-R-2023-Challenge-main_me/constraints/WDIMACS_requirements_temp.txt"
    ...
    with open(os.path.join(file_dir, f"post_processed_{os.path.basename(args.file_path)}"), 'wb') as handle:
