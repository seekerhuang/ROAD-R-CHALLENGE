...
def main():
    ...
    parser.add_argument('--SEQ_LEN', default=16,
                        type=int, help='NUmber of input frames,16 for even GPUS and 15 for odd GPUS,make sure to change the batch size accordingly')
    parser.add_argument('--TEST_SEQ_LEN', default=80,
    ...
    parser.add_argument('--TRAIN_SUBSETS', default='train_1,train_2,train_3',
    ...
    parser.add_argument('-l','--LR', '--learning-rate', 
                        default=0.00041, type=float, help='initial learning rate')
    ...
    parser.add_argument('--WEIGHT_DECAY', default=0.035, 
    ...
    parser.add_argument('--GEN_TOPK', default=30, 
                        type=int, help='topk at the time of generation')
    parser.add_argument('--GEN_NMS', default=0.46, 
    ...
    # Program arguments
    parser.add_argument('--MAN_SEED', default=3407, 
    ...
    parser.add_argument('--req_loss_weight', default=8.0, type=float, help='weight for the logic-based loss')
    ...
    parser.add_argument('--pretrained_model_path2', default=None, type=str, help='path pretrained 2')
    ...
    parser.add_argument('--flow_path',default="/root/autodl-tmp/unimatch-master/output/road_data_flow",type=str, help='flow_path')
    ...
    if args.TASK == 1:
        ...
        args.labelled_videos = "2014-06-25-16-45-34_stereo_centre_02,2014-07-14-14-49-50_stereo_centre_01," \
            ...
            "2015-03-03-11-31-36_stereo_centre_01,2014-06-26-09-53-12_stereo_centre_02,2014-11-25-09-18-32_stereo_centre_04,2015-02-13-09-16-26_stereo_centre_02"
        #2014-06-26-09-53-12_stereo_centre_02,2014-11-25-09-18-32_stereo_centre_04,2015-02-13-09-16-26_stereo_centre_02 for task 2
        '''
        Note:
    ...
    if args.MODE == 'train':
        if args.FBN:
            if args.MULTI_GPUS:
                ...
                net.backbone.backbone.apply(utils.set_bn_eval)
                net.backbone.backbone.rgbbackbone.apply(utils.set_bn_eval)
                net.backbone.backbone.rgbbackbone.dinobackbone.apply(utils.set_bn_eval)
            else:
                net.backbone.apply(utils.set_bn_eval)
